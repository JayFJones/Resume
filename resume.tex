...
% - Consider using a serif font.  Could just be me, but I think it looks better.
% - I don't know if it's your goal to have a one page resume, but I have to believe that
%   if 15 years there must be some juicy stuff that isn't listed here.  For example,
%   horrendous bugs that you've worked thru
\name{James F. Jones}
% \address used twice to have two lines of address
% Same thing here about possibly moving the address above the horizontal rule.
...
\section{EXPERIENCE} {\sl Staff Engineer} \hfill since 2003 \\
                ...
                C4/E6000 CMTS CLI Team
                 ...
                 % Since Rhapsody is better known as a music service, you might want to
                 % qualify it here with something like "IBM's Rhapsody UML tool"
                 ...
                 %   the company
                 % - Prototyped development tool virtualization for team
                 \end{itemize}
...
%                 \end{itemize}
                ...
                % regex might be worth mentioning as a langauge
\section{COMPUTER SKILLS} {\sl Languages \& Software:} C/C++, Perl, Java,
                ...
                % If you really want to be buzword compliant, there are zillions more
                % acronyms you could list here.  For example: IPv6, SSH, HTTP, SSL,
                % FTP, TFTP, Telnet, SNMP/MIB, etc
...
% This section doesn't feel like it belongs.  I would consider omitting it.
